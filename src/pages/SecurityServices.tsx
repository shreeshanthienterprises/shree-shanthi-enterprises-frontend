    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen h-screen w-full flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(to bottom, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.5) 100%), url('https://res.cloudinary.com/ds4stvfr3/image/upload/v1758108640/5f6ed60d-fd65-437b-bedc-585387acfcd5_biucff.png')"
          }}
        />
